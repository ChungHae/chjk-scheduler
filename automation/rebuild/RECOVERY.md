...
- r145: live 68c5b4e6 / test 491ae2a2 (2026-08-25 작업본, PC test 파일 = r145, 미배포 — 대표자명 자동 배정: 업체 상세 '대표자' 단독 일치 시 매칭(동명이인 제외, 공백무시·쉼표복수 지원), 매칭순서 별칭→업체명→원장명→대표자명 + 미배정 헤더 [자동 배정 재실행] 소급 버튼 + 업로드 자동배정 vbiz를 업체목록 기준으로)
