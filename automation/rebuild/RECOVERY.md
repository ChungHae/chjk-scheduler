...
- r133: live 8ebea432 / test de2ad23d (2026-08-24 작업본, PC test 파일 = r133, 미배포 — 미배정 매칭을 일정>업체 목록 기준으로 전환(사업자번호로 원장 연결, 홈택스 표기변형 중복 제거), 자동배정에 업체명 직접일치 추가, 별칭표 관리(목록/삭제=입금 복귀/배정 전체취소/별칭 재적용))
