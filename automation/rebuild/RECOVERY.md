...
- r148: live e3c1e163 / test c041844b (2026-08-25 작업본, PC test 파일 = r148, 미배포 — 미수현황 표를 다른 표와 동일하게 화면 좌우 전체폭으로 확장 + 업체 목록을 무한스크롤(200+200)에서 페이지네이션(1페이지 20개, 이전/다음 버튼)으로 교체하여 렉 개선)
