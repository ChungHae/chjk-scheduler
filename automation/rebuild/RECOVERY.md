...
- r142: live 36b675c6 / test de8e2c46 (2026-08-24 작업본, PC test 파일 = r142, 미배포 — 사명 변경 케이스: 같은 사업자번호가 이 사업장에 있어도 타사업장 안내 표시(inThis 억제 제거), 이동 배정을 직접 배정으로(새 사명 유지·중복 등록 없음·별칭 미학습))
