...
- r131: live 2d0e5580 / test 61876369 (2026-08-24 작업본, PC test 파일 = r131, 미배포 — 초기화 범위 '별칭만 유지'로 변경, 원장에서 입금 기한(결제조건) select 편집, 조정(상계) 추가/삭제, 미수 제외/복원(칩+패널), 원장 엑셀 키 버그 수정)
