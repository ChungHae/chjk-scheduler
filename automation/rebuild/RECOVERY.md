...
- r150: live 19fe1cb7 / test 56566e28 (2026-08-25 작업본, PC test 파일 = r150, 미배포 — 미수현황(회계>매입매출)도 업체 목록과 동일하게 페이지네이션(1페이지 20개, 이전/다음) 적용해 렉 개선. 상단 요약 칩(총 미수·연령 합계 등)은 전체 데이터 기준 그대로 유지, 표 행만 페이지 단위로 자름. 검색·상태필터·사업장전환·탭전환 시 1페이지로 리셋)
